        ...
        <div class="right">
            ...
            <form action="{{ route('admin.lupaPasswordAdmin') }}" method="POST">
                ...
                <div class="form-group password-container">
                    <input type="password" name="pw_admin" id="pw_admin" placeholder="Password baru" class="form-control password-input">
                ...
                <a href="{{ route('indexadmin') }}" class="kembali">Kembali ke login</a>
            </form>
        </div>
    </div>
    <script>
