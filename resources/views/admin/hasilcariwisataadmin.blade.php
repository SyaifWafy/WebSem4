...
<head>
    ...
    <title>JemberWonder - Cari Wisata Admin</title>
...
<body>
    ...
    <div class="center">
        <div class="d-flex justify-content-center">
            <form action="{{ route('cariwisataadmin') }}" method="GET" class="input-group"
            ...
            <main style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 75px;">
                @foreach ($wisatas as $wisata)
                    <div
                        ...
                        <a href="{{ route('detailWisataAdmin', $wisata->kd_wisata) }}"
